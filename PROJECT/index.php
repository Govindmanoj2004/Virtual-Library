...
<body id="top">
    ...
    <div id="page" class="s-pagewrap ss-home">
        ...
        <header id="masthead" class="s-header">
            ...
            <div class="row s-header__navigation">
                ...
                <nav class="s-header__nav-wrap">
                    ...
                    <ul class="s-header__nav">
                        ...
                        <li><a href="Guest/Login.php" title="">Log in</a></li>
                        <li class="has-children">
                            <a href="#0" title="" class="">Sign in</a>
                            <ul class="sub-menu">
                                <li><a href="Guest/User_reg.php">Sign in as User</a></li>
                                <li><a href="Guest/Author_reg.php">Sign in as Author/Seller</a></li>
                            </ul>
                        </li>
                        <li><a href="Guest/Booklist.php" title="">Library</a></li>
                        <li class="has-children">
            ...
            <a class="s-header__search-trigger" href="Guest/Search.php">
            ...
            <div id="bricks" class="bricks">
                ...
                <div class="masonry">
                    ...
                    <div class="bricks-wrapper" data-animate-block>
                        ...
                        <?php
                        $slBooks="SELECT * FROM tbl_books b inner join tbl_genre g on g.genre_id=b.book_genre inner join tbl_author a on a.author_id=b.book_author ORDER BY RAND() LIMIT 12";
                        ...
                        <article class="brick entry" data-animate-el>
                            ...
                            <div class="entry__text">
                                ...
                                <a class="entry__more-link" href="Guest/Viewmore.php?bookid=<?php echo $bookData["book_id"] ?>">View More</a>
                            </div> <!-- end entry__text -->
