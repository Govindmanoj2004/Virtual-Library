...
$pass=$authordata['author_pass'];
//Update 
if(isset($_POST['btn_change']))
{
$Oldpass=$_POST['txt_oldPass'];
$Newpass=$_POST['txt_newPass'];
$reNewpass=$_POST['txt_rePass'];	
	if($pass==$Oldpass)
	{
		if($Newpass==$reNewpass)
		{
			$authorEdit="update tbl_author set author_pass='".$Newpass."' where author_id=".$authorId;
		...
		else
		{
			?>
				<script>
				alert('New and Re-type pass doesnt match')
...
<table width="200" border="1" align="center">
  <tr>
    ...
    <td><label for="txt_oldPass"></label>
      <input type="Password" name="txt_oldPass" id="txt_oldPass"/></td>
  </tr>
  <tr>
    <td>New Password</td>
    <td><label for="txt_newPass"></label>
      <input type="password" name="txt_newPass" id="txt_newPass" /></td>
  </tr>
  <tr>
    <td>Re-Type Password</td>
    <td><label for="txt_rePass"></label>
      <input type="password" name="txt_rePass" id="txt_rePass" /></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><input type="submit" name="btn_change" id="btn_change" value="Change Password" />
...
<head>
    ...
    <title>Change Password -Virtual library</title>
