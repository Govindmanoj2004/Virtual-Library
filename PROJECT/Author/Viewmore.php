...
<body id="top">
                    ...
                    <article class="entry format-standard">
                        ...
                        <header class="entry__header">
                            <?php 
                                $i="";
                                $bookId=$_GET['bookid'];
                                $selbook="select * from tbl_books b inner join tbl_genre g on g.genre_id=b.book_genre inner join tbl_author a on a.author_id=b.book_author where book_id='".$bookId."'";
                        ...
                        <div class="entry__media">
                            <figure class="featured-image">
                                <img src="../Assets/Files/Author/BookCover/<?php echo $data['book_cover'] ?>" >
                            </figure>
                        </div>
                        ...
                        <div class="content-primary">
                            ...
                            <a class="btn btn--stroke u-fullwidth" href="Books.php?did=<?php echo $data["book_id"] ?>">Delete</a>
                            <button class="btn btn--stroke u-fullwidth" onclick='updateStock(<?php echo $data["book_id"] ?>)'>Add Stock</button>
                    </article> <!-- end entry -->
    ...
    ================================================== -->
            ...
            <script>  
            function updateStock(bid)
            {
                var qty = prompt("Enter Stock Quantity.");
                console.log(bid);
                console.log(qty);
                $.ajax({
                    url: "../Assets/AjaxPages/AjaxStock.php?bid=" + bid + "&qty=" + qty,
