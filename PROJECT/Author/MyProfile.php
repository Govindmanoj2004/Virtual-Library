...
$auid=$_SESSION['auid'];
 $slctUser="Select * from tbl_author u inner join tbl_district d on d.district_id=author_district inner join tbl_place p on p.place_id=u.author_place where u.author_id=".$auid;
...
****************/
        ...
        .pCard_card .pCard_up {
            ...
            width: 100%;
            height: 437px;
            background-image: url("../Assets/Files/User/Photo/<?php echo $dataUser['author_photo'] ?>");
                ...
                <div class="pCard_card">
                    <div class="pCard_up">
                        <div class="pCard_text">
                            <h2 id="NameProfile"><?php echo $dataUser['author_name'] ?></h2>
                            <p><?php echo $dataUser['author_email'] ?></p>
                        </div>
                    ...
                    <div class="pCard_down">
                        <div>
                            <p>Address</p>
                            <p><?php echo $dataUser['author_address'] ?></p>
                        </div>
                        <div>
                            <p>Location</p>
                        ...
                        <div>
                            <p>Contact</p>
                            <p><?php echo $dataUser['author_contact'] ?></p>
                        </div>
                    </div>
