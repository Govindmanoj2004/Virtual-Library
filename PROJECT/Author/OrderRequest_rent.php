...
<title>Order Request(Rent)</title>
</head>

<body>
<h2 align="center">Order Request(Renting)</h2>
<table width="532" height="82" border="1" align="center">
  ...
  <?php
    $slctRqst="select * from tbl_rent r inner join tbl_books a on a.book_id=r.book_id where a.book_author='".$_SESSION['auid']."'";
    ...
    <tr>
      ...
      <td>
        <?php
          if($data['book_sell']==0 && $data['book_rent']==0)
          {
            echo "Free";
          }
          else
          {
            echo $data['rent_amount'];
          }
        ?>
      </td>
      <td>
        <?php
          $numOfReaders="SELECT COUNT(user_id) AS num_of_users FROM tbl_rent WHERE book_id =".$data['book_id'];
          $numresult=$con->query($numOfReaders);
          $numOfData=$numresult->fetch_assoc();
          echo $numOfData['num_of_users'];
        ?>
      </td>
    </tr>
  <?php
			...
			<div class="row s-header__navigation">
				...
				<nav class="s-header__nav-wrap">
                    ...
                    <li class="current-menu-item"><a href="Homepage.php" title="">Home</a></li>
                        ...
                        <li class="has-children">
                            <a href="#0" title="" class="">Book request</a>
                            <ul class="sub-menu">
                                <li><a href="OrderRequest_buy.php">Request to buy</a></li>
                                <li><a href="OrderRequest_rent.php">Request to rent</a></li>
                            </ul>
                        </li>
...
<div class="masonry">
	...
	<div class="bricks-wrapper" data-animate-block>
		...
		<?php
		$slBooks="select * from tbl_rent r inner join tbl_books a on a.book_id=r.book_id inner join tbl_genre g on g.genre_id=a.book_genre inner join tbl_category ca on ca.cat_id=a.book_cat where a.book_author='".$_SESSION['auid']."'";
			...
			<div class="entry__text">
				<div class="entry__header">
					<div class="entry__meta">
						...
						<span class="byline">
							<?php
                 $numOfReaders="SELECT COUNT(user_id) AS num_of_users FROM tbl_rent WHERE book_id =".$bookData['book_id'];
                 $numresult=$con->query($numOfReaders);
                 $numOfData=$numresult->fetch_assoc();
				 if($numOfData['num_of_users']==1)
				 {
					echo $numOfData['num_of_users']." Reader";
				 }
				 else
				 {
					echo $numOfData['num_of_users']." Readers";
				 }
               ?>
                <!-- Readers -->
						</span>
