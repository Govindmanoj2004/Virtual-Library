...
$address="";
//Select Author
$selAuthor="select * from tbl_author where author_id='".$AuthorId."'";
$result = $con->query($selAuthor);
...
$AuthorEdit="update tbl_author set author_name ='".$name."',author_email='".$email."',author_contact='".$contact."',author_address='".$address."' where author_id=".$AuthorId;
if($con->query($AuthorEdit))
{
	?>
	<script>
...
<title>Edit Profile(Author)</title>
</head>
...
<table width="200" border="1" align="center">
  <tr>
    ...
    <td><label for="txt_name"></label>
      <input type="text" name="txt_name" id="txt_name" value="<?php echo $Authordata['author_name'] ?>"/></td>
  </tr>
  <tr>
    <th scope="row">Email</th>
    <td><label for="txt_email"></label>
      <input type="email" name="txt_email" id="txt_email" value="<?php echo $Authordata['author_email'] ?>"/></td>
  </tr>
  <tr>
    <th scope="row">Contact</th>
    <td><label for="txt_contact"></label>
      <input type="text" name="txt_contact" id="txt_contact" value="<?php echo $Authordata['author_contact'] ?>"/></td>
  </tr>
  <tr>
    <th scope="row">Address</th>
    <td><label for="txt_address"></label>
      <textarea name="txt_address" id="txt_address" value="" cols="45" rows="5"><?php echo $Authordata['author_address'] ?></textarea></td>
  </tr>
  <tr>
    <th colspan="2" align="center" scope="row"><input type="submit" name="btn_edit" id="btn_edit" value="Edit" /></th>
    </tr>
</table>
...
<head>
    ...
    <title>Edit Profile -Virtual library</title>
...
<body id="top">
    ...
    <div id="page" class="s-pagewrap">
            ...
            <div class="row s-header__navigation">
                ...
                <nav class="s-header__nav-wrap">
                    ...
                    <li class="current-menu-item"><a href="Homepage.php" title="">Home</a></li>
                        ...
                        <?php
                        $slct="select * from tbl_subscription where author_id='".$AuthorId."'";
        ...
        <div id="content" class="s-content s-content--page" style="padding: 110px;">
<form action="" method="post">
<h1 align="center">Edit Profile</h1>
