...
if(isset($_GET['wid']))
 	{
	 $delQry="delete from tbl_wishlist where wishlist_id= '".$_GET["wid"]."'";
	 if ($con->query($delQry)){
		 ?>
        	<script>
...
<table width="200" border="1" align="center">
  ...
  <?php
  $i="";
  $wishlst="select * from tbl_wishlist w INNER JOIN tbl_books b on b.book_id=w.book_id INNER JOIN tbl_genre g on g.genre_id=b.book_genre INNER JOIN tbl_author a on a.author_id=b.book_author where user_id='".$id."'";
  $result=$con->query($wishlst);
  ...
  <tr>
    ...
    <td><?php echo $data['book_des'] ?></td>
    <td><?php echo $data['author_name'] ?></td>
    <td><a href="Mywishlist.php?wid=<?php echo $data["wishlist_id"] ?>">Remove from wishlist</a></td>
  </tr>
  <?php
  }
  ?>
			...
			<div class="s-pageheader">
				<div class="row">
					<div class="column large-12">
						<h1 class="page-title">
							<span class="page-title__small-type">List:</span>
							WishList
						</h1>
					</div>
				</div>
...
<div class="masonry">
	...
	<div class="bricks-wrapper" data-animate-block>
		...
		<?php
		$slBooks="select * from tbl_wishlist w INNER JOIN tbl_books b on b.book_id=w.book_id INNER JOIN tbl_genre g on g.genre_id=b.book_genre INNER JOIN tbl_author a on a.author_id=b.book_author where user_id='".$id."'";
		...
		<article class="brick entry" data-animate-el>
			...
			<div class="entry__text">
				...
				<a class="entry__more-link" href="Mywishlist.php?wid=<?php echo $bookData["wishlist_id"] ?>">Remove from Wishlist</a>
			</div> <!-- end entry__text -->
