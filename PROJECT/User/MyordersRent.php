...
<div class="masonry">
	...
	<div class="bricks-wrapper" data-animate-block>
		...
		<?php
		$slBooks="select * from tbl_rent r inner join tbl_books bk on bk.book_id=r.book_id inner join tbl_genre g on g.genre_id=bk.book_genre inner join tbl_author au on au.author_id=bk.book_author where user_id=".$_SESSION['uid'];
    ...
    $currentDate=date("Y-m-d");
      ...
      <?php
    //   if($bookData['rent_exp']!=$currentDate)
    //   {
    //     if($bookData['rent_status']==1)
    //     {
    ...
    //   }
      ?>
        ...
        <div>
				<?php
    if($bookData['rent_status']==0)
      {
        ?>
        <p>Payment pending</p></td>
        <?php
      }
    else if($bookData['rent_status']==1)
    	{
    	  ?>
    	  <a class="entry__more-link" href="../Assets/Files/Author/Book/<?php echo $bookData['book_file'] ?>">View <?php echo $bookData['book_name'] ?></a>
    	  <?php
    	}
      else if($bookData['rent_status']==3)
      {
        ?>
          <a class="entry__more-link" href="Payment.php?reRent=<?php echo $bookData['rent_id'] ?>" >Renew to continue reading</a>
        <?php
      }
      ?>
      </div>
