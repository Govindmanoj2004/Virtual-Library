			...
			<div class="row s-header__navigation">
				...
				<nav class="s-header__nav-wrap">
					...
					<ul class="s-header__nav">
                        ...
                        <li class="has-children">
                            <a href="#0" title="" class="">Shelf</a>
                            <ul class="sub-menu">
                                <li><a href="MyordersBuy.php">Orders</a></li>
                                <li><a href="Myordersrent.php">Books</a></li>
                            </ul>
                        </li>
                        <?php
                        $slct="select * from tbl_subscription where user_id='".$_SESSION['uid']."'";
                        ...
                        <li class="has-children">
                            ...
                            <ul class="sub-menu">
                                <li><a href="contact.html" title="">Contect</a></li>
			...
			<div class="s-pageheader">
				<div class="row">
					<div class="column large-12">
						<h1 class="page-title">
							<span class="page-title__small-type">My.</span>
							Orders
						</h1>
					</div>
				</div>
...
<div class="masonry">
	...
	<div class="bricks-wrapper" data-animate-block>
		...
		<?php
		$slBooks="select * from tbl_booking r inner join tbl_books bk on bk.book_id=r.book_id inner join tbl_genre g on g.genre_id=bk.book_genre inner join tbl_author au on au.author_id=bk.book_author where user_id=".$_SESSION['uid'];
			...
			<div class="entry__text">
				<div class="entry__header">
					<div class="entry__meta">
						...
						<span class="byline">
							By:
							<a href="#0"><?php echo $bookData['author_name'] ?></a>
						</span>
					</div>
    ...
    if($bookData['booking_status']==1)
      {
        ?>
        <p class="entry__more-link" style="margin-bottom:2px;">Order Placed</p>
        <?php
      }
    else if($bookData['booking_status']==2)
    	{
    	  ?>
        <p class="entry__more-link" style="margin-bottom:2px;">Order Confirmed</p>
        <?php
    	}
      else if($bookData['booking_status']==3)
    	{
    	  ?>
        <p class="entry__more-link" style="margin-bottom:2px;">Order Shipped</p>
        <?php
    	}
      else if($bookData['booking_status']==4)
    	{
    	  ?>
        <p class="entry__more-link" style="margin-bottom:2px;">Out For Delivery</p>
        <?php
    	}
      else if($bookData['booking_status']==5)
    	{
    	  ?>
        <p class="entry__more-link" style="margin-bottom:2px;color:green;">Order Delivered</p>
        <?php
    	}
      ?>
      </div>
      <diV>
      <?php
        if($bookData['booking_status']==5)
          {
            ?>
              <a class="entry__more-link" href="Rating.php?bId=<?php echo $bookData["book_id"] ?>">Rate Book</a>
              <?php
          }
      ?>
				</div>
      <diV>
          ...
          {
            ?>
              <a class="entry__more-link" href="Complaint.php?bid=<?php echo $bookData["book_id"] ?>">Post complaint</a>
              <?php
          }
          ?>
				</div>
