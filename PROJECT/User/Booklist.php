			...
			<div class="s-pageheader">
				<div class="row">
					<div class="column large-12">
						<h1 class="page-title">
							<span class="page-title__small-type">Books.</span>
							Library
						</h1>
					</div>
				</div>
...
<div class="masonry">
	...
	<div class="bricks-wrapper" data-animate-block>
		...
		<?php
		$slBooks="SELECT * FROM tbl_books b inner join tbl_genre g on g.genre_id=b.book_genre inner join tbl_author a on a.author_id=b.book_author";
		...
		<article class="brick entry" data-animate-el>
			...
			<div class="entry__text">
				...
				<a class="entry__more-link" href="Booklist.php?lst=<?php echo $bookData["book_id"] ?>">Add to Wishlist</a>
			</div> <!-- end entry__text -->
