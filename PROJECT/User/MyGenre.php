...
if(isset($_GET['did']))
 {
	 $delQry="delete from tbl_mygenre where mygenre_id= '".$_GET["did"]."'";
	 if ($con->query($delQry))
	 {
		 ?>
        	<script>
			alert('Deleted Successfully')
			window.location='MyGenre.php'
			</script>
        <?php
	}
	else
	{
			?>
        	<script>
			alert('Delection Unsuccessfully')
			window.location='MyGenre.php'
			</script>
        <?php
	}
...
<table width="200" border="1" align="center">
  ...
  <tr>
  <?php
  	$selMygenre="select * from tbl_mygenre m INNER JOIN tbl_genre g on g.genre_id=m.genre_id inner join tbl_category cat on cat.cat_id=g.genre_cat where m.user_id='".$userId."'";
	$rMygenre = $con->query($selMygenre);
	$i="";
	while($data = $rMygenre->fetch_assoc())
	{
		$i++;
	?>
    <td><?php echo $i ?></td>
    ...
    <td><a href="MyGenre.php?did=<?php echo $data["mygenre_id"] ?>">Delete</a></td>
  </tr>
  <?php
	}
	?>
    ...
    <td colspan="4" align="center">
        <a href="AddGenre.php">Edit Genre</a>
    </td>
    </tr>
</table>
</div>
