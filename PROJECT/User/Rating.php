    	...
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
	        	...
	        	<div class="form-group">
                    <input type="hidden" name="txt_bid" id="txt_bid" value="<?php echo $_GET["bId"];?>" />
	        	</div>
	        	<div class="form-group">
...
$(document).ready(function(){
    ...
    $('#save_review').click(function(){
        ...
        else
        {
            $.ajax({
                ...
                method:"POST",
                data:{rating_data:rating_data, user_name:user_name, user_review:user_review, book_id:book_id},
    ...
    function load_rating_data()
    {
        ...
        $.ajax({
            url:"../Assets/AjaxPages/AjaxRating.php",
            method:"POST",
            data:{action:'load_data',bid:book_id},
            dataType:"JSON",
            success:function(data)
            {
				$("#review_content").html(data);
