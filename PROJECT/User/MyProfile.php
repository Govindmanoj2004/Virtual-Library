...
$id=$_SESSION['uid'];
 $slctUser="Select * from tbl_user u inner join tbl_district d on d.district_id=user_district inner join tbl_place p on p.place_id=u.user_place where u.user_id=".$id;
 $resultUser = $con->query($slctUser);
...
****************/
        ...
        .pCard_card .pCard_up {
            ...
            width: 100%;
            height: 437px;
            background-image: url("../Assets/Files/User/Photo/<?php echo $dataUser['user_photo'] ?>");
                ...
                <div class="pCard_card">
                    <div class="pCard_up">
                        <div class="pCard_text">
                            <h2 id="NameProfile"><?php echo $dataUser['user_name'] ?></h2>
                            <p><?php echo $dataUser['user_email'] ?></p>
                        </div>
                    ...
                    <div class="pCard_down">
                        ...
                        <div>
                            <p>Location</p>
                            <p><?php echo $dataUser['district_name'] ?>,<br /><?php echo $dataUser['place_name'] ?></p>
                        </div>
                        <div>
                            <p>Contact</p>
                    ...
                    <div class="pCard_back">
                        ...
                        <a href="EditProfile.php" class="btn btn--primary u-fullwidth">INFO</a>
                        <a href="ChangePassword.php" class="btn btn--primary u-fullwidth">PASSWORD</a>
                    </div>
                </div>
            </div>
        </div>
