...
$userEdit="update tbl_user set user_name ='".$name."',user_email='".$email."',user_contact='".$contact."',user_address='".$address."' where user_id=".$userId;
if($con->query($userEdit))
{
	?>
	<script>
...
<table width="20%" border="0">
  <tr>
    ...
    <td><label for="txt_name"></label>
      <input type="text" name="txt_name" id="txt_name" value="<?php echo $Userdata['user_name'] ?>"/></td>
  </tr>
  <tr>
    <td scope="row">Email</td>
    <td><label for="txt_email"></label>
      <input type="email" name="txt_email" id="txt_email" value="<?php echo $Userdata['user_email'] ?>"/></td>
  </tr>
  <tr>
    <td scope="row">Contact</td>
    <td><label for="txt_contact"></label>
      <input type="text" name="txt_contact" id="txt_contact" value="<?php echo $Userdata['user_contact'] ?>"/></td>
  </tr>
  <tr>
    <td scope="row">Address</td>
    <td><label for="txt_address"></label>
      <textarea name="txt_address" id="txt_address" value="" cols="45" rows="5"><?php echo $Userdata['user_address'] ?></textarea></td>
  </tr>
  <tr>
