                ...
                <div class="column lg-12">
                    ...
                    <article class="entry format-standard">
                        ...
                        <header class="entry__header">
                            <?php 
                                $bookId=$_GET['bookid'];
                                $selbook="select * from tbl_books b inner join tbl_genre g on g.genre_id=b.book_genre inner join tbl_author a on a.author_id=b.book_author inner join tbl_category ca on ca.cat_id=b.book_cat where book_id='".$bookId."'";
                        ...
                        <div class="content-primary">
                            ...
                            <form method="post">
                                <input type="submit" name="btn_login" id="btn_login" value="Login" class="btn--primary u-fullwidth">
                            </form>
                    </article> <!-- end entry -->
