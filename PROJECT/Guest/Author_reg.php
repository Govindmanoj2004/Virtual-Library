<?php
 ...
 if(isset($_POST['btn_register']))
 {
	...
	move_uploaded_file($tempphoto, '../Assets/Files/Author/Photo/'.$photo);
	//Proof
	$proof=$_FILES['fle_proof']['name'];
	$tempproof=$_FILES['fle_proof']['tmp_name'];
	move_uploaded_file($tempproof, '../Assets/Files/Author/Proof/'.$proof);
  //Checking
  $checkQuery="select * from tbl_author where author_email=".$email."and author_pass=".$pass;
  ...
  {
	//Insertion
	$authorIns="insert into tbl_author (author_name,author_email,author_contact,author_address,author_district,author_place,author_photo,author_proof,author_pass) values ('$name','$email','$contact','$address','$district','$place','$photo','$proof','$pass')";
	if($pass==$cpass)
	{
		if($con->query($authorIns))
			{
				?>
<script>
...
<script>
  ...
  window.location = 'Author_reg.php'
</script>
<?php
			}
	}
      ...
      <div class="container">
        <div class="signup-content">
          <div class="signup-form">
            <h2 class="form-title">Sign up as author/seller</h2>
            <form method="POST" class="register-form" id="register-form" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input requird type="text" name="txt_contact" id="txt_contact" placeholder="Your contact number"
